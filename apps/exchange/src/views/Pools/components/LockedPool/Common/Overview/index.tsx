...
import { Box, Text, Flex, MessageText, Message } from '@plexswap/ui-plex'
...
const Overview: React.FC<React.PropsWithChildren<OverviewPropsType>> = ({
  ...
  const formattediWaya = useMemo(() => {
    return formatiWaya({ lockedAmount, duration, ceiling })
  ...
  const newFormattediWaya = useMemo(() => {
    ...
    return formatiWaya({ lockedAmount: amount, duration: lockDuration, ceiling })
