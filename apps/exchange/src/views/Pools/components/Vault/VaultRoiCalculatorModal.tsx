import { Box, ButtonMenu, ButtonMenuItem } from '@plexswap/ui-plex'
...
export const VaultRoiCalculatorModal = ({
  ...
  return (
    <RoiCalculatorModal
      ...
      stakingTokenBalance={
        pool.userData?.stakingTokenBalance ? wayaAsBigNumber.plus(pool.userData?.stakingTokenBalance) : wayaAsBigNumber
      }
