...
import { Flex, Link, Skeleton, Text, TimerIcon } from '@plexswap/ui-plex'
...
const EndsInCell: React.FC<React.PropsWithChildren<FinishCellProps>> = ({ pool }) => {
  const { poolId, totalStaked, startBlock, endBlock, isFinished } = pool
  ...
  const showLoading = isLoadingPublicData && !isWayaPool && !isFinished
  return (
