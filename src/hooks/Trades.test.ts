...
describe('Trade', () => {
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(bscTokens.wbnb, '1'), new TokenAmount(bscTokens.waya, '1'))],
  //         [PairState.INVALID, new Pair(new TokenAmount(bscTokens.busd, '1'), new TokenAmount(bscTokens.waya, '1'))],
  //         [PairState.LOADING, new Pair(new TokenAmount(bscTokens.busd, '1'), new TokenAmount(bscTokens.wbnb, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(bscTokens.wbnb, bscTokens.waya)
  //         return {
  //           pairs,
  //         }
  //       })
  //       expect(result.current.pairs).toStrictEqual([
  //         new Pair(new TokenAmount(bscTokens.wbnb, '1'), new TokenAmount(bscTokens.waya, '1')),
  //       ])
  //     })
  ...
  //         [PairState.EXISTS, new Pair(new TokenAmount(bscTokens.wbnb, '1'), new TokenAmount(bscTokens.waya, '1'))],
  //         [PairState.EXISTS, new Pair(new TokenAmount(bscTokens.wbnb, '1'), new TokenAmount(bscTokens.waya, '1'))],
  //         [PairState.EXISTS, new Pair(new TokenAmount(bscTokens.waya, '1'), new TokenAmount(bscTokens.wbnb, '1'))],
  //         [PairState.EXISTS, null],
  //       ])
  //       const { result } = renderHook(() => {
  //         const pairs = Trades.useAllCommonPairs(bscTokens.wbnb, bscTokens.waya)
  ...
  //       ])
  //     })
  //     it('should get all pair combinations wbnb, waya', () => {
  //       mockUsePairs.mockClear()
  //       renderHook(() => {
  //         Trades.useAllCommonPairs(bscTokens.wbnb, bscTokens.waya)
  //       })
  ...
  //       const allowPairs = [new Pair(new TokenAmount(bscTokens.wbnb, '1'), new TokenAmount(bscTokens.waya, '1'))]
  //       const argA = CurrencyAmount.ether('1000000')
  //       const argB = bscTokens.waya
  //       renderHook(
  //         () => {
