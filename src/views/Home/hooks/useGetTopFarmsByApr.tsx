...
import { useFarms, usePriceWayaBusd } from 'state/farms/hooks'
...
const useGetTopFarmsByApr = (isIntersecting: boolean) => {
  ...
  useEffect(() => {
    const getTopFarmsByApr = (farmsState: DeserializedFarm[]) => {
      ...
      const farmsWithApr: FarmWithStakedValue[] = farmsWithPrices.map((farm) => {
        ...
        return { ...farm, apr: wayaRewardsApr, lpRewardsApr }
      })
  ...
  }, [setTopFarms, farms, fetchStatus, wayaPriceBusd, topFarms, regularWayaPerBlock, chainId])
