...
const VaultStakeModal: React.FC<React.PropsWithChildren<VaultStakeModalProps>> = ({
  ...
  const usdValueStaked = new BigNumber(stakeAmount).times(wayaPriceBusd)
  const formattedUsdValueStaked = wayaPriceBusd.gt(0) && stakeAmount ? formatNumber(usdValueStaked.toNumber()) : ''
  ...
  return (
    ...
    >
      ...
      <BalanceInput
        ...
        currencyValue={wayaPriceBusd.gt(0) && `~${formattedUsdValueStaked || 0} USD`}
      ...
      {pool.vaultKey === VaultKey.WayaVault && wayaAsNumberBalance ? (
