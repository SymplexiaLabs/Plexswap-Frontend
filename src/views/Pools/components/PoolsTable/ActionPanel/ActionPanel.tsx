...
import { Box, Flex, HelpIcon, Text, useTooltip, useMatchBreakpointsContext } from '@plexswap/ui-plex'
import { useVaultPoolByKey } from 'state/pools/hooks'
import { getVaultPosition, VaultPosition } from 'utils/wayaPool'
import BigNumber from 'bignumber.js'
import { DeserializedPool, VaultKey, DeserializedLockedWayaVault, DeserializedLockedVaultUser } from 'state/types'
...
import WayaVaultApr from './WayaVaultApr'
...
const ActionPanel: React.FC<React.PropsWithChildren<ActionPanelProps>> = ({ account, pool, expanded }) => {
  ...
  return (
    <StyledActionPanel expanded={expanded}>
      ...
      <ActionContainer>
        {isMobile && vaultKey === VaultKey.WayaVault && vaultPosition === VaultPosition.None && (
          <WayaVaultApr pool={pool} userData={vaultData.userData} vaultPosition={vaultPosition} />
        )}
        <Box width="100%">
