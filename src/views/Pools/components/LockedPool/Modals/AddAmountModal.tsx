...
import { Modal, Box, MessageText, Message, Checkbox, Flex, Text } from '@plexswap/ui-plex'
...
const AddAmountModal: React.FC<React.PropsWithChildren<AddAmountModalProps>> = ({
  ...
  const usdValueStaked = useBUSDWayaAmount(lockedAmountAsBigNumber.toNumber())
  const usdValueNewStaked = useBUSDWayaAmount(totalLockedAmount)
