...
import { Card, Flex, Text, Skeleton } from '@plexswap/ui-plex'
...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('PLEXSWAP', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('WAYA + Fees')
