...
import { Flex, IconButton, useModal, CalculateIcon, TooltipText, useTooltip, Text } from '@plexswap/ui-plex'
...
const ApyButton: React.FC<React.PropsWithChildren<ApyButtonProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      ...
      {strikethrough && <Text color="secondary">{t('Boost only applies to base APR (WAYA yield)')}</Text>}
    </>,
    {
      placement: 'top',
    },
