...
import { Text, HelpIcon, Skeleton, useTooltip } from '@plexswap/ui-plex'
...
const Multiplier: React.FunctionComponent<React.PropsWithChildren<MultiplierProps>> = ({ multiplier }) => {
  ...
  const tooltipContent = (
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion of WAYA rewards each farm receives, as a proportion of the WAYA produced each block.',
        )}
      </Text>
      <Text my="24px">
