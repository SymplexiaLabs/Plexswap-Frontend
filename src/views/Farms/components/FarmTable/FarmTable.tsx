...
import { Button, ChevronUpIcon, RowType } from '@plexswap/ui-plex'
...
const FarmTable: React.FC<React.PropsWithChildren<ITableProps>> = ({ farms, wayaPrice, userDataReady }) => {
  ...
  const generateRow = (farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('PLEXSWAP', '')
