import { Button, Modal, Text, Grid, InjectedModalProps, Box } from '@plexswap/ui-plex'
  ...
  return (
    <Modal title={title} hideCloseButton headerBackground="gradients.cardHeader">
      <Grid style={{ gap: '16px' }} maxWidth="360px">
        ...
        <Text small>
          {t(
            'Our special features are currently available only on BNB Chain! Come over and join the community in the fun!',
          )}
        </Text>
        <Button
          variant="secondary"
