...
const Container = styled(Flex)`
  ...
  background: linear-gradient(0deg, rgba(39, 38, 44, 0.4), rgba(39, 38, 44, 0.4)),
    linear-gradient(180deg, #f5a700 0%, #cc8b00 100%);
  ${({ theme }) => theme.mediaQueries.md} {
    padding: 0px;
    background: linear-gradient(180deg, #f5a700 0%, #cc8b00 100%);
  }
`
    ...
    <>
      ...
      {warningTextAsParts.map((text, i) => (
        <Text
          ...
          small
          as="span"
          bold={text === 'https://swap.plexfinance.us'}
          color={text === 'https://pplexfinance.us' ? '#FFFFFF' : '#BDC2C4'}
        >
          {text}
        </Text>
      ))}
    ...
    <Container className="warning-banner">
      {isMobile || isMd ? (
        ...
        <>
          <InnerContainer>
            <img
              src="/images/home/warnings/phishing-warning.webp"
              alt="phishing-warning"
              width="92px"
              onError={(e) => {
                const fallbackSrc = '/images/home/warnings/phishing-warning.png'
