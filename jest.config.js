...
const customJestConfig = {
  ...
  moduleNameMapper: {
    ...
    '^@plexswapswap/style/(.*)$': '<rootDir>/packages/style/$1',
    '^@plexswaswap/style': '<rootDir>/packages/style',
    ...
    '^@plexswap/wagmi/chains': ['<rootDir>/packages/wagmi/chains'],
    '^@plexswap/wagmi/connectors/miniProgram': ['<rootDir>/packages/wagmi/connectors/miniProgram'],
    '^@plexswap/wagmi/connectors/binanceWallet': ['<rootDir>/packages/wagmi/connectors/binanceWallet'],
    '^@plexswap/wagmi': ['<rootDir>/packages/wagmi/src'],
  },
